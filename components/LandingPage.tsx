      ...
      <nav className="fixed w-full z-[90] top-14 px-8 md:px-24">
        <div className="max-w-[1600px] mx-auto bg-white/5 backdrop-blur-3xl border border-white/10 rounded-[4rem] py-6 px-12 md:px-20 flex justify-between items-center shadow-[0_40px_100px_rgba(0,0,0,0.5)]">
          ...
          <div className="flex items-center gap-8">
            <button onClick={onLoginClick} className="px-10 py-4 rounded-3xl text-white bg-sky-600 font-black text-base hover:bg-sky-500 transition-all shadow-2xl shadow-sky-900/40">تسجيل الدخول</button>
            <button onClick={onRegisterClick} className="px-10 py-4 rounded-3xl text-slate-200 bg-white/5 border border-white/10 font-black text-base hover:bg-white/10 transition-all hidden sm:block">إنظم الينا</button>
          </div>
        </div>
      </nav>
